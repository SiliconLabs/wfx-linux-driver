...
int wsm_read_mib(struct wfx_dev *wdev, int vif_id, u16 mib_id,
		 void *buf, size_t buf_size);
int wsm_write_mib(struct wfx_dev *wdev, int vif_id, u16 mib_id,
		  void *buf, size_t buf_size);
...
int wsm_set_bss_params(struct wfx_vif *wvif,
...
int wsm_set_edca_queue_params(struct wfx_vif *wvif,
