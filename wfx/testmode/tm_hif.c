...
static u16 l_ui16_hif_buffer_set;
static u16 l_ui16_hif_buffer_get;
...
void hif_buffer_add(u16 id)
{
	...
	if (!l_b_hif_pm_enable ||
	    l_ui16_hif_buffer_set == TM_HIF_BUFFER_LEN)
		return;
...
{
	u16 ui16_nbDataToFlush = l_ui16_hif_buffer_set -
				      l_ui16_hif_buffer_get;
