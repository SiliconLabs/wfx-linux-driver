...
typedef struct __attribute__((__packed__)) wsm_hi_mib_beacon_wake_up_period_s {
        u8       NumBeaconPeriods;                 /*0 - Reserved. 1 to 255 - The number of beacon periods the device will doze before waking up to receive a beacon.*/
        u8       Reserved;                         /*Reserved, set to 0*/
        __le16   ListenInterval;                   /*0 - (default) Device will wake up according to NumBeaconPeriods settings.            1 to 65535 - This will be the upper limit for which the device may choose to adaptively extend its wake-up period during times that the device is idle.             It is recommended that the value set should be that of the listen interval sent in the association request by the device to the AP. The method of adaptation used by the device is proprietary.*/
...
typedef union wsm_mib_data_u {
        ...
        __le32                                        InactivityTimer;                /* Element :4149*/
} WsmMibData_t;
